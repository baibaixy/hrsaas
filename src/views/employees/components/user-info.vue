  ...
  <div class="user-info">
    ...
    <el-form label-width="220px">
      ...
      <div class="block">
        ...
        <el-row class="inline-info" type="flex" justify="center">
          <el-col :span="12">
            <el-button type="primary" @click="onSaveUpdatePersonal"
              >保存更新</el-button
            >
            <el-button @click="$router.back()">返回</el-button>
          </el-col>
...
import { getUserDetailApi, updatePersonal } from '@/api/employees'
export default {
  data() {
    return {
  ...
  methods: {
    ...
    employeeTouSuccess({ url }) {
      this.userInfo.staffPhoto = url
    },
    employeePicSuccess({ url }) {
